...
--Criando o fact_skill_demand_monthly
...
SELECT
    ...
    CASE WHEN jpf.job_no_degree_mention = TRUE THEN 1 ELSE 0 END AS degree_mention
FROM
...
SELECT
    ...
    SUM(degree_mention) AS degree_mentioned_postings_count
FROM
    job_postings_prep
GROUP BY ALL
ORDER BY
